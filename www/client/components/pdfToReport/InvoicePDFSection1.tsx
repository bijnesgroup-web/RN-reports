            ...
            <View>
                ...
                <View style={commonStyles.fieldRow}>
                    ...
                    {(() => {
                        ...
                        // If empty we still render an empty fieldValue to keep layout consistent
                        if (!raw) {
                            return <Text style={commonStyles.fieldValue}></Text>;
                        }

                        // Tweak this based on font size + available width. Start with ~36-44 chars and adjust visually.
                        ...
                        for (const w of words) {
                            // + (firstLineWords.length > 0 ? 1 : 0) accounts for a space before the word
                        ...
                        // If the entire value fits in the firstLineLimit, render as normal (no ellipsis)
